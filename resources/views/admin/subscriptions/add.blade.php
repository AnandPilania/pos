    ...
    <div class="bg-body-light">
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Add Subscription</h1>
            </div>
        </div>
    </div>
    <!-- END Hero -->
    ...
    <div class="content">
        <div class="block block-rounded block-bordered">
            <div class="block-content">
                ...
                <form action="{{route('admin.subscriptions.add')}}" class="js-validation" method="POST">
                    @csrf
                    <h2 class="content-heading">Subscription Information</h2>
                    <div class="row">
